...
rel2 <- religiosity %>% arrange(desc(Mean.Pop))
...
ggplot(rel2, aes(x=Mean.Pop,y=Mean.Religiosity)) +
  geom_point() +
  theme_minimal() +
  coord_cartesian(xlim=c(0,1100000), ylim=c(0.7,.92))
...
# 1.  Which religious group correlates most strongly in a given area with the 
...
# 4.  Examine the axis scales. How could you modify the code above to more 
